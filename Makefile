...
TEST_ENGINE_DOCTYPE_SRCS := doctype/doctype.cxx doctype/sgmlnorm.cxx doctype/sgmltag.cxx doctype/colondoc.cxx doctype/mailfolder.cxx doctype/medline.cxx doctype/bibtex.cxx doctype/cipc.cxx doctype/cipp.cxx doctype/fgdc.cxx doctype/fgdcsite.cxx doctype/dif.cxx doctype/emacsinfo.cxx doctype/eos_guide.cxx
