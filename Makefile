...
TEST_ENGINE_DOCTYPE_SRCS := doctype/doctype.cxx doctype/sgmlnorm.cxx doctype/sgmltag.cxx doctype/colondoc.cxx doctype/mailfolder.cxx doctype/medline.cxx doctype/anzlic.cxx doctype/anzmeta.cxx doctype/bibtex.cxx doctype/cipc.cxx doctype/cipp.cxx doctype/fgdc.cxx doctype/fgdcsite.cxx doctype/dif.cxx doctype/emacsinfo.cxx doctype/eos_guide.cxx doctype/filename.cxx doctype/filmline.cxx doctype/firstline.cxx doctype/ftp.cxx doctype/gils.cxx doctype/gilsxml.cxx doctype/gopher.cxx doctype/html.cxx doctype/htmltag.cxx doctype/iafadoc.cxx doctype/iknowdoc.cxx doctype/incoming/sgmlgils.cxx doctype/irlist.cxx doctype/listdigest.cxx doctype/litmed.cxx doctype/maildigest.cxx doctype/marcdump.cxx doctype/markdown.cxx doctype/memodoc.cxx doctype/oneline.cxx doctype/para.cxx doctype/referbib.cxx
