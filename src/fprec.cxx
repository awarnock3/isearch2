// $Id: fprec.cxx,v 1.4 1998/05/12 16:49:02 cnidr Exp $
/************************************************************************
Copyright Notice
...
void 
FPREC::SetFileName(const STRING& NewFileName) {
...
void 
FPREC::GetFileName(STRING *StringBuffer) const {
  *StringBuffer = FileName;
}


void 
FPREC::SetFilePointer(FILE* NewFilePointer) {
  FilePointer = NewFilePointer;
}


PFILE 
FPREC::GetFilePointer() const {
  return FilePointer;
}


void 
FPREC::SetPriority(const INT NewPriority) {
  Priority = NewPriority;
}


INT 
FPREC::GetPriority() const {
  return Priority;
}


void 
FPREC::SetClosed(const GDT_BOOLEAN NewClosed) {
  Closed = NewClosed;
}


GDT_BOOLEAN 
FPREC::GetClosed() const {
  return Closed;
}


void 
FPREC::SetOpenMode(const STRING& NewOpenMode) {
  OpenMode = NewOpenMode;
}


void 
FPREC::GetOpenMode(STRING *StringBuffer) const {
