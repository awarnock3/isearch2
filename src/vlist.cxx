...
VLIST* 
//VLIST::GetNodePtr(const SIZE_T Index) const {
VLIST::GetNodePtr(const INT Index) const {
  //  SIZE_T x = 1;
  INT x = 1;
...
void 
//VLIST::EraseAfter(const SIZE_T Index) {
VLIST::EraseAfter(const INT Index) {
