// $Id: nfield.cxx,v 1.3 1998/05/12 16:49:13 cnidr Exp $
/************************************************************************
Copyright Notice
...
void 
NUMERICFLD::SetGlobalStart(INT4 x) {
  GlobalStart=x;
}


void 
NUMERICFLD::SetNumericValue(DOUBLE x) {
  NumericValue=x;
}


INT4 
NUMERICFLD::GetGlobalStart() {
  return(GlobalStart);
}


DOUBLE 
NUMERICFLD::GetNumericValue() {
  return(NumericValue);
}
