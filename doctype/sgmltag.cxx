// $Id: sgmltag.cxx,v 1.6 2000/02/04 22:50:50 cnidr Exp $
/************************************************************************
Copyright Notice
...
void 
SGMLTAG::ParseFields(PRECORD NewRecord) 
{
  PFILE  fp;
  STRING fn;
  GPTYPE RecStart, 
...
Post:	On success, return value is filled with char pointers to first 
		...
		returns count of useful tags in numtags
...
#define NEED_END 1
char **
//sgml_parse_tags(char *b, int len)
SGMLTAG::sgml_parse_tags(char *b, int len, int *numtags)
{
...
*/
char *
SGMLTAG::find_end_tag(char **t, char *tag)
{
  char *tt;
  int i;
